...
public class CalculatorTest {
	...
	public void initCalculator() {
		System.out.println(MessageFormat.format("Appel avant le test numéro {0}", ++testNumber));
		calculator = new Calculator();
	}

	@AfterEach
	public void calculatorToNull() {
		System.out.println(MessageFormat.format("Appel après le test numéro {0}", testNumber));
		calculator = null;
	}
	...
	public void testAdd_twoPositiveNumbers() {
		...
		// fail("Fonction pas encore implémentée");
	}
