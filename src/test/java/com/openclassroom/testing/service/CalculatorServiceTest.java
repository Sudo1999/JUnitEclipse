...
public class CalculatorServiceTest {
	...
	@BeforeEach
	public void init() {
		service = new CalculatorServiceImplementation(calculator);
	}
	...
	public void testCalculate_shouldUseCalculator_forAddition() {
		...
		verify(calculator).add(1, 2);		// On vérifie que la méthode add(1, 2) du calculator mockée a bien été utilisée.
		...
		assertThat(result).isEqualTo(3);	// On vérifie enfin le résultat de la méthode service.calculate testée.
	}
